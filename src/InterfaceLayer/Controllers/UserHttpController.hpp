...
public:
	...
	METHOD_LIST_BEGIN
		ADD_METHOD_TO(UserHttpController::create_user,  "/user" ,   { drogon::Post   });
	    ADD_METHOD_TO(UserHttpController::get_user,         "/user" ,   { drogon::Get    });
		ADD_METHOD_TO(UserHttpController::get_all_users,"/users",   { drogon::Get    });
		ADD_METHOD_TO(UserHttpController::update_user,  "/user",    { drogon::Patch  });
		ADD_METHOD_TO(UserHttpController::delete_user,  "/user",    { drogon::Delete });
	METHOD_LIST_END
