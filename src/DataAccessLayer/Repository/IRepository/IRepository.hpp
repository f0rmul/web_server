...
public:
	...
	virtual drogon::Task<void> set_value(const ValueType&) = 0;
	virtual drogon::Task<std::vector<ValueType>> get_values(const KeyType&) = 0;
	virtual drogon::Task<void> update_value(const ValueType&) = 0;
	virtual drogon::Task<void> delete_value(const ValueType&) = 0;
